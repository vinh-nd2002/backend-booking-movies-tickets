...
public class GoogleDriveConfig {
	private static final String APPLICATION_NAME = "booking-movie-ticket"; // Application name
	...
	private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
		...
		LocalServerReceiver receiver = new LocalServerReceiver.Builder().setPort(8081).build(); // PORT URI OF GOOGLE
																								// SERVICE
